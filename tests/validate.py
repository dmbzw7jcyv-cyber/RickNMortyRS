...
with tempfile.TemporaryDirectory() as folder:
    ...
    for required in ['Server', 'Client', 'Shared', 'Portal', 'Config', 'Service', 'Renderer', 'Transit', 'Gun', 'Phoenix', 'AvatarLoader', 'AvatarStyle', 'Body', 'Lab', 'Sequences', 'Motion', 'Storage', 'Punch', 'Meeseeks', 'Commands', 'Models', 'Navigation', 'Targeting', 'Emotes']:
...
subprocess.run(['lune', 'run', 'tests/meeseeks.luau'], cwd=root, check=True)
subprocess.run(['lune', 'run', 'tests/meeseeks_service.luau'], cwd=root, check=True)
